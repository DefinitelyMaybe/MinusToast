...
-------------------------------------------------------------------------------
ElecProj = PlaceableObject.Subclass("ElecProj")

-------------------------------------------------------------------------------
function ElecProj:Constructor( args )
...
-------------------------------------------------------------------------------
function ElecProj:Fire(payload, direction, force)
	if payload ~= nil then
...
function ElecProj:NetSerializeConstruction( stream )
end

function ElecProj:NetDeserializeConstruction( stream )
end

-------------------------------------------------------------------------------
function ElecProj:NetSerialize( stream )
...
-------------------------------------------------------------------------------
function ElecProj:NetDeserialize( stream )
...
--------------------------------------------------------------------------------
function ElecProj:SetSource( source )
...
-------------------------------------------------------------------------------
EntityFramework:RegisterGameObject(ElecProj)